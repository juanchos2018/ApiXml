...
#Region "Metodos"
    ...
    Public Sub New()
        ' pc_Servidor = "DESKTOP-PEKLP69\MSSQLSERVER01"
        ' pc_BaseDatos = "COM" & ruc & periodo
        ' pc_Usuario = "sa"
        ' pc_Contrasena = "123456"
    End Sub
    ...
    Private Function Conectar_BD() As Boolean
        Try
            Dim ruc As String = "20449213166"
            Dim periodo As String = "18"
            If po_Conexion Is Nothing Then 'verifica que no exista conexion 
                ...
                ' po_Conexion = New SqlConnection("Data Source=DESKTOP-PEKLP69\MSSQLSERVER01; Initial Catalog=COM2044921316618; Integrated Security=True;UID=sa; PWD=123456;")
                po_Conexion = New SqlConnection("Server=DESKTOP-PEKLP69\MSSQLSERVER01;DataBase=COM2044921316618;UID=sa; PWD=123456;")
                'go_Sql.Asignar_Servidor("DESKTOP-1D95MG3\\SQL2014", "sa", "20449266448", "COM"+data.ruc+data.anio);
                po_Conexion.Open()
                Return True
            Else
    ...
    Public Sub Elim7inar_Items(ByVal TxtTabla As String, ByVal Condicion As String)
        If Conectar_BD() = True Then ' conectando BD
    ...
    Public Function FuncionProc(ByVal TxtProc As String, ByVal sparam As String, ByVal valor As Object) As DataSet
        ...
        Return lo_ds
    End Function
    Public Function FuncionProc(ByVal TxtProc As String, ByVal ruc As String, ByVal periodo As String) As DataSet
        Dim lo_ds As New DataSet
        If Conectar_BD() = True Then ' conectando BD
            Dim lo_comandoProc As New SqlCommand(TxtProc, po_Conexion)
            lo_comandoProc.CommandType = CommandType.StoredProcedure
