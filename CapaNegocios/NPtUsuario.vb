...
#Region "Constructors"
    ...
    Public Sub New(ByVal idUsuario As String, ByVal idNivelUsuario As String, ByVal [alias] As String, ByVal password As String, ByVal idEstado As String, ByVal swCaja As Boolean, ByVal swTurno As Boolean, ByVal fullname As String)
        Me.New()
    End Sub

#End Region
#Region "Metodos"
    Public Sub Agregar(d As NPtUsuario)
    ...
    End Sub
    Public Sub Actualizar(d As NPtUsuario)
        Dim parametros() As Object = {"@idusuario", "@idnivelusuario", "@alias", "@password", "@idestado", "@swcaja", "@swturno", "@fullname", "@swalmacen", "@islogin_sql"}
        Dim tipoParametro() As Object = {SqlDbType.Char, SqlDbType.Char, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.Char, SqlDbType.Bit, SqlDbType.Bit, SqlDbType.VarChar, SqlDbType.Bit, SqlDbType.Bit}
        Dim valores() As Object = {d.idusuario, d.idnivelusuario, d.alias, d.password, d.idestado, d.swcaja, d.swturno, d.fullname, d.swalmacen, d.islogin_sql}
        sql.EjecutarProcedure("Str_ptusuario_U", parametros, valores, tipoParametro, 10)
    End Sub
    Public Function Agregar(d As NPtUsuario, Retornatable As Boolean) As NPtUsuario
        ...
        Return d
    End Function
    Public Function Actualizar(d As NPtUsuario, Retornatable As Boolean) As NPtUsuario
        Dim parametros() As Object = {"@idusuario", "@idnivelusuario", "@alias", "@password", "@idestado", "@swcaja", "@swturno", "@fullname", "@swalmacen", "@islogin_sql"}
        Dim tipoParametro() As Object = {SqlDbType.Char, SqlDbType.Char, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.Char, SqlDbType.Bit, SqlDbType.Bit, SqlDbType.VarChar, SqlDbType.Bit, SqlDbType.Bit}
        Dim valores() As Object = {d.idusuario, d.idnivelusuario, d.alias, d.password, d.idestado, d.swcaja, d.swturno, d.fullname, d.swalmacen, d.islogin_sql}
        Dim dt As New DataTable
        ...
        Return d
    End Function
    Public Sub Eliminar(d As NPtUsuario)
    ...
    Public Function Lista() As DataTable
        ...
        Return dt
    End Function
    Public Function Lista(d As NPtUsuario) As DataTable
        Dim parametros() As Object = {"@idusuario"}
        Dim tipoParametro() As Object = {SqlDbType.Char}
        Dim valores() As Object = {d.idusuario}
        Dim dt As New DataTable
        ...
        Return dt
    End Function
    Public Function Registro(d As NPtUsuario) As NPtUsuario
        Dim parametros() As Object = {"@idusuario"}
        Dim tipoParametro() As Object = {SqlDbType.Char}
        Dim valores() As Object = {d.idusuario}
        Dim dt As New DataTable
    ...
    Public Function obtener_idusuario(nombre As String, pws As String) As String
        Dim lc_usuario() As String = {"'" & nombre & "'", "'" & pws & "'"}
        Return sql.ValorEscalar("dbo.FObtenerIdUsuario", lc_usuario, 1)
    End Function
#End Region
