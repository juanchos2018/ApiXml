...
Public Class NDetPreVenta_Compra_Lote
...
#Region "Metodos"
    ...
    Public Sub Agregar(d As NDetPreVenta_Compra_Lote)
        ...
        Dim tipoParametro() As Object = {SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.Char, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.Decimal, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.Char, SqlDbType.Decimal, SqlDbType.BigInt}
        ...
        sql.EjecutarProcedure("Str_DetPreVenta_Compra_Lote_I", parametros, valores, tipoParametro, 21)
    End Sub
    Public Sub Actualizar(d As NDetPreVenta_Compra_Lote)
        ...
        Dim tipoParametro() As Object = {SqlDbType.BigInt, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.Char, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.Decimal, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.Char, SqlDbType.Decimal, SqlDbType.BigInt}
        ...
        sql.EjecutarProcedure("Str_DetPreVenta_Compra_Lote_U", parametros, valores, tipoParametro, 22)
    End Sub
    Public Sub Eliminar(d As NDetPreVenta_Compra_Lote)
        Dim parametros() As Object = {"@idLote"}
        Dim tipoParametro() As Object = {SqlDbType.BigInt}
        Dim valores() As Object = {d.idLote}
        sql.EjecutarProcedure("Str_DetPreVenta_Compra_Lote_D", parametros, valores, tipoParametro, 1)
    End Sub
    Public Function Lista() As DataTable
        ...
        dt = sql.ProcedureSQL("Str_DetPreVenta_Compra_Lote_S", parametros, valores, tipoParametro, 1).Tables(0)
        Return dt
    End Function
    Public Function Lista(d As NDetPreVenta_Compra_Lote) As DataTable
        Dim parametros() As Object = {"@idLote"}
        Dim tipoParametro() As Object = {SqlDbType.BigInt}
        Dim valores() As Object = {d.idLote}
        Dim dt As New DataTable
        ...
        Return dt
    End Function
    Public Function Registro(d As NDetPreVenta_Compra_Lote) As NDetPreVenta_Compra_Lote
        Dim parametros() As Object = {"@idLote"}
        Dim tipoParametro() As Object = {SqlDbType.BigInt}
        Dim valores() As Object = {d.idLote}
        Dim dt As New DataTable
    ...
    Public Function DetalleLote(idagencia As String, idalmacen As String, idTipoDocumento As String, numerodocumento As String) As DataTable
        Dim cad As String = " SELECT    IdLote,NroLote,Cantidad,SaldoLote,IdArticulo FROM  DetPreVenta_Compra_Lote "
        cad += " where rtrim(IdAlmacenCL)='" & idalmacen & "' AND rtrim(IdAgenciaCL)='" & idagencia & "' AND IdTipoDocumentoCL='" & idTipoDocumento & "' "
        cad += " AND rtrim(SerieCL)+rtrim(NumeroDocumentoCL)='" & numerodocumento & "'"
    ...
    Public Function DetalleLote(idagencia As String, idalmacen As String, idTipoDocumento As String, numerodocumento As String, idarticulo As String, serie As String) As DataTable
        Dim cad As String = " SELECT    IdLote, IdAlmacen, IdAgencia, IdProveedor, IdTipoDocumento, Serie, NumeroDocumento, IdArticulo, item, Cantidad, NroLote, IdAlmacenCL, IdAgenciaCL, IdCliente, IdTipoDocumentoCL, SerieCL,  NumeroDocumentoCL, Proyecto, ItemCL, IdArticuloCL, SaldoLote ,IdLoteCompra FROM  DetPreVenta_Compra_Lote "
        cad += " where rtrim(IdAlmacenCL)='" & idalmacen & "' AND rtrim(IdAgenciaCL)='" & idagencia & "' AND IdTipoDocumentoCL='" & idTipoDocumento & "' "
        cad += " AND rtrim(SerieCL)='" & serie & "' and rtrim(NumeroDocumentoCL)='" & numerodocumento & "'"
        Return sql.EjecutarConsulta("lote", cad).Tables(0)
    End Function
#End Region
End Class
